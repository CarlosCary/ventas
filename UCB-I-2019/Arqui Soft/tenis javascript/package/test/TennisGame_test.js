...
describe('TennisGame', function(){
    ...
    it ('El puntaje deberia devolver Win for player1 si el jugador 1 realizo Cuatro puntos y el jugador 2 realizo dos puntos', function(){
        game.P1Score();
        game.P1Score();
        game.P1Score();
        game.P1Score();
    ...
    it ('El puntaje deberia devolver Advantage player2 si el jugador 1 realizo tres puntos y el jugador 2 realizo cuatro puntos', function(){
        game.P1Score();
        game.P1Score();
        game.P1Score();
        game.P2Score();
        ...
        game.P2Score();
        game.P2Score();
        expect(game.getScore()).equal("Advantage player2");
    });

    it ('El puntaje deberia devolver Win for player2 si el jugador 1 realizo tres puntos y el jugador 2 realizo cinco puntos', function(){
        game.P1Score();
        game.P1Score();
        game.P1Score();
        game.P2Score();
    ...
    it ('El puntaje deberia devolver Fifteen-Thirty si el jugador 1 realizo un punto y el jugador 2 realizo dos puntos', function(){
        game.P1Score();
        game.P2Score();
        game.P2Score();
        expect(game.getScore()).equal("Fifteen-Thirty");
    });
    
    it ('El puntaje deberia devolver Fifteen-Forty si el jugador 1 realizo un punto y el jugador 2 realizo tres puntos', function(){
        game.P1Score();
        game.P2Score();
        game.P2Score();
        game.P2Score();
        expect(game.getScore()).equal("Fifteen-Forty");
    });

    it ('El puntaje deberia devolver Win for player2 si el jugador 1 realizo un punto y el jugador 2 realizo cuatro puntos', function(){
        game.P1Score();
        game.P2Score();
        game.P2Score();
        game.P2Score();
    ...
    it ('El puntaje deberia devolver Thirty-Forty si el jugador 1 realizo dos puntos y el jugador 2 realizo tres puntos', function(){
        game.P1Score();
        game.P1Score();
        game.P2Score();
        game.P2Score();
        game.P2Score();
        expect(game.getScore()).equal("Thirty-Forty");
    });
    ...
    it ('El puntaje deberia devolver Deuce si el jugador 1 realizo cuatro puntos y el jugador 2 realizo cuatro puntos', function(){
        game.P1Score();
        game.P1Score();
        game.P1Score();
        game.P1Score();
